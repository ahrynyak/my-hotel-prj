    ...
    <div class="section">
        ...
        <div class="section_content">
            ...
            <span>спільного користування. Вам не потрібно турбуватися про посуд та кухонну техніку,
                оскільки кухня є повністю укомплектован, а саме:</span>
            <ul>
...
<asp:Content ID="Content4" ContentPlaceHolderID="GreenHouseContentPlaceHolderTabPrices"
    ...
    <div class="section">
        ...
        <div class="section_content">
            ...
            період 21.04.2013 - 25.09.2013 <span class="GreenHouseNormalTextP1">(високий сезон)</span>
            <ul>
    ...
    <div class="section">
        ...
        <div class="section_content">
            Низький сезон
            <ul>
                <li>при проживанні більше 10 днів - знижка 10 грн./особа</li>
                <li>при проживанні більше 20 днів - знижка 15 грн./особа</li>
            </ul>
            Високий сезон
            <ul>
                <li>при проживанні більше 16 днів - знижка 5 грн./особа</li>
                <li>при проживанні більше 20 днів - знижка 10 грн./особа</li>
            </ul>
        </div>
        <div class="section_footer">
        </div>
