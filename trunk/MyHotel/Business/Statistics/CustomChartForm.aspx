    ...
    <div>
        <table width="90%" style="vertical-align: top;" bordercolor="red" border="1">
            ...
            <tr>
                ...
                <td>
                    <asp:ImageButton ID="ImageButtonAddXYAxis" runat="server" ImageUrl="~/icons/add1.ico" Height="16px" Width="16px" />
                    <asp:ImageButton ID="ImageButtonRemoveXYAxis" runat="server" ImageUrl="~/icons/remove.png" Height="16px" Width="16px" />
                </td>
                <td>
