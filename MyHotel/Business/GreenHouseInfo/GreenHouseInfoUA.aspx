...
<asp:Content ID="Content2" ContentPlaceHolderID="GreenHouseContentPlaceHolderTabHome"
    ...
    <div class="section">
        ...
        <div class="section_content">
            ...
            відпочинку. 
            <br />
            Також до послуг наших гостей повністю обладнана кухня-їдальня, мангал
            ...
            перешкоджати Вашому відпочинку. 
            <br />
...
<asp:Content ID="Content4" ContentPlaceHolderID="GreenHouseContentPlaceHolderTabPrices"
    ...
    <div class="section">
        ...
        <div class="section_content">
            <ul>
                <li>при поселенні протягом наступних 5-7 днів,  від дати замовлення, ціна на проживання 60-70 грн з особи</li>
                <li>при проживанні більше 15 днів знижка 10 грн від вартості номера</li>
            </ul>
        </div>
        <div class="section_footer">
        </div>
